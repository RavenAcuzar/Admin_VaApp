<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Corporate.aspx.cs" Inherits="Admin_VaApp.Corporate" %>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="checkbox checkbox-inline">
                                <input type="checkbox" value="ID" id="chkID" /><label for="chkID">ID</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input type="checkbox" value="Title" id="chkTitle" /><label for="chkTitle">Title</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                            ...
                            <div class="checkbox checkbox-inline">
                                <input type="checkbox" value="Department" id="chkDepartment" /><label for="chkDepartment">Department</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input type="checkbox" value="Region" id="chkRegion" /><label for="chkRegion">Region</label>
                            </div>
                            <div class="checkbox checkbox-inline">
                                <input type="checkbox" value="Type" id="chkType" /><label for="chkType">Type</label>
                            </div>
                            <div class="checkbox checkbox-inline">
