                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:CompareValidator ID="CompareValidator6" CssClass="alert-danger" runat="server" ErrorMessage="Required Field"
                                    ...
                                    <br />
                                    <asp:Label CssClass="control-label" runat="server">USD 52,400 from April </asp:Label> <label id="pYear" style="font-weight: normal;"> </label> to March <label id="cYear" style="font-weight: normal;"> </label>
                                ...
                                <asp:CompareValidator ID="CompareValidator7" CssClass="alert-danger" runat="server" ErrorMessage="Required Field"
                                    ...
                                    <br />
                                    <asp:Label CssClass="control-label" runat="server">USD 72,000 from April </asp:Label> <label id="pYear1" style="font-weight: normal;"></label> to March <label id="cYear1" style="font-weight: normal;"> </label>
                                ...
                                <asp:CompareValidator ID="CompareValidator8" CssClass="alert-danger" runat="server" ErrorMessage="Required Field"
                                    ...
                                    <asp:ListItem Selected="True" Value="-1">Please Select...</asp:ListItem>
                                        ...
                                        <asp:ListItem Text="Diamond" Value="Platinum"></asp:ListItem>
